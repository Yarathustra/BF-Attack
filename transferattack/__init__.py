...
attack_zoo = {
    ...
    'bfmumodig': ('.gradient.bfmumodig','BF_MUMODIG'),
    'gaa': ('.gradient.gaa', 'GAA'),  
    'foolmix': ('.gradient.foolmix', 'Foolmix'),  
    'bfgaa': ('.gradient.bfgaa', 'BFGAA'),
    'bffoolmix': ('.gradient.bffoolmix', 'BFFoolmix'),
    
    # input transformation
    ## Untargeted
    'dim': ('.input_transformation.dim', 'DIM'),
    'bfdim': ('.input_transformation.bfdim', 'BF_DIM'),
    'rdi': ('.input_transformation.rdi', 'RDI'),
    'tim': ('.input_transformation.tim', 'TIM'),
    'bftim': ('.input_transformation.bftim', 'BF_TIM'),
    'sim': ('.input_transformation.sim', 'SIM'),
    'bfsim': ('.input_transformation.bfsim', 'BF_SIM'),
    'dem': ('.input_transformation.dem', 'DEM'),
    'admix': ('.input_transformation.admix', 'Admix'),
    'bfadmix': ('.input_transformation.bfadmix', 'BF_Admix'),
    ...
    'bfops': ('.input_transformation.bfops', 'BF_OPS'),
    ## Targeted
    ...
    'incresv2ens': ('.ensemble.incresv2ens', 'IncResv2Ens'),
    ## Targeted
